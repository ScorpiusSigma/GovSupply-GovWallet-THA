export default function StaffInfoCard(props: any) {
	...
	return (
		<div data-testid="staff-info-card" className="bg-[#E6DCB1] flex flex-col sm:flex-row text-[#161853] h-24 justify-center sm:justify-evenly sm:items-center items-start p-5 rounded-lg sm:gap-6">
